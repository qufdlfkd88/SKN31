...
*********************************************************************************************/
use testdb;
-- testdb.a 처럼 테이블 앞에 db를 붙이기 싫다면 사용
-- create table member
...
insert into member (id, password, name, gender, age) values ('id-4', '2222', '유관순', 'f', 20); -- check에 위배되어 -값은 오류
...
-- defalut 값이 있는 컬럼에 null을 넣을 경우 반드시 명시해야함
select * from member;
