...
CREATE TABLE emp(
    ...
    CONSTRAINT fk_emp_dept FOREIGN KEY(dept_id) REFERENCES dept(dept_id) ON DELETE SET NULL, -- ON DELETE SET NULL 대신 ON DELETE CASCADE 사용가능 (참조하는 값이 삭제된다면 NULL로 변경)
