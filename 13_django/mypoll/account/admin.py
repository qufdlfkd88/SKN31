...
## UserAdmin을 상속받에서 구현하며, register()에 UserModel과 함께 전달.

## class 변수로 Field들을 정의
### list_display: list - 사용자 메인화면에서 사용자 목록에 보여줄 항목들
### add_fieldsets: tuple - 등록화면에 나올 항목(Field)들을 정의
### fieldsets: tuple - 수정화면에 나올 항목들을 정의 (형식은 add_fieldsets 동일)
